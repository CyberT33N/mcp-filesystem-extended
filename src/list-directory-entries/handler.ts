 ...
 *
 * The response always includes `type` for every entry. Recursive traversal is enabled
 * by default. Additional metadata is included only when `includeMetadata` is enabled.
 *
