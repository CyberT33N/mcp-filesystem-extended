...
# Unit 6: Domain Shared

## Tasks
- [x] **6.1 Resume and guardrail policies** → `.plan/6-domain-shared/6.1-resume-and-guardrail-policies/orchestration.md`
...
- [x] **6.2 Search core and runtime profile** → `.plan/6-domain-shared/6.2-search-core-and-runtime-profile/orchestration.md`
  - Classification: `ISOLATED`
