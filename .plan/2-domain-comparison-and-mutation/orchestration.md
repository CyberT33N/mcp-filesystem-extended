...
## Tasks
- [ ] **2.1 Comparison handler and contract normalization** → [`2.1-comparison-handler-and-contract-normalization.md`](./2.1-comparison-handler-and-contract-normalization.md)
...
- [ ] **2.2 Mutation handler and helper normalization** → [`2.2-mutation-handler-and-helper-normalization.md`](./2.2-mutation-handler-and-helper-normalization.md)
  - Classification: `ISOLATED`
  - Status: `pending`
  - Complexity: `HIGH`
...
- [ ] **2.3 Comparison and mutation final handoff normalization** → [`2.3-comparison-and-mutation-final-handoff-normalization.md`](./2.3-comparison-and-mutation-final-handoff-normalization.md)
