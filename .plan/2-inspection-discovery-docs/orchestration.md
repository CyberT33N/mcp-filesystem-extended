...
- [x] **2.2 `find_paths_by_name` doc set** → [`2.2-find-paths-by-name-doc-set.md`](./2.2-find-paths-by-name-doc-set.md)
  - Classification: ISOLATED
  - Status: done
  - Complexity: MEDIUM
  - Execution Surface Band: GREEN
...
- [x] **2.3 `find_files_by_glob` doc set** → [`2.3-find-files-by-glob-doc-set.md`](./2.3-find-files-by-glob-doc-set.md)
  - Classification: ISOLATED
  - Status: done
  - Complexity: MEDIUM
  - Execution Surface Band: GREEN
