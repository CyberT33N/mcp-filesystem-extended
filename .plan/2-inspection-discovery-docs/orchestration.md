...
|----|------------|-------------|------|--------|-------------|--------------|
| D1 | 2.1 | 1.5 | WAITING | UNRESOLVED | Discovery docs must reflect the final traversal/preflight/runtime-budget semantics. | discovery endpoint docs |
| D2 | 2.2 | 1.5 | WAITING | UNRESOLVED | Discovery docs must reflect the final traversal/preflight/runtime-budget semantics. | discovery endpoint docs |
| D3 | 2.3 | 1.5 | WAITING | UNRESOLVED | Discovery docs must reflect the final traversal/preflight/runtime-budget semantics. | discovery endpoint docs |

## Execution Order
1. Any task after unit 1.5 resolves.
