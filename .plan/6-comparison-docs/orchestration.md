...
## Tasks
- [ ] **6.1 `diff_files` doc set** → [`6.1-diff-files-doc-set.md`](./6.1-diff-files-doc-set.md)
...
- [ ] **6.2 `diff_text_content` doc set** → [`6.2-diff-text-content-doc-set.md`](./6.2-diff-text-content-doc-set.md)
...
|----|------------|-------------|------|--------|-------------|--------------|
| D1 | 6.2 | 6.1 | SEQUENTIAL | UNRESOLVED | The raw-text diff docs should contrast themselves against the file-backed diff docs. | comparison endpoint docs |
